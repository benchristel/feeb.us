(function() {
    ...
    var na = B("Opera") || B("OPR"),
        C = B("Trident") || B("MSIE"),
        oa = B("Edge"),
        D = B("Gecko") && !(-1 != A.toLowerCase().indexOf("webkit") && !B("Edge")) && !(B("Trident") || B("MSIE")) && !B("Edge"),
        pa = -1 != A.toLowerCase().indexOf("webkit") && !B("Edge");
    ...
    var va = k.document,
        wa = va && C ? ra() || ("CSS1Compat" == va.compatMode ? parseInt(sa, 10) : 5) : void 0;
    var E;
    if (!(E = !D && !C)) {
        var F;
        if (F = C) F = 9 <= wa;
    ...
    function xa(a) {
        ...
        if (a) {
            ...
            for (c = d = 0; b = f[c]; c++) {
                var h = b.className,
                    m;
                if (m = "function" == typeof h.split) m = 0 <= ga(h.split(/\s+/), a);
                m && (e[d++] = b)
            }
            e.length = d;
            return e
    ...
    Ea.prototype.get = function() {
        var a;
        0 < this.h ? (this.h--, a = this.f, this.f = a.next, a.next = null) : a = this.j();
        return a
    };
    Ea.prototype.put = function(a) {
        this.m(a);
        this.h < this.l && (this.h++, a.next = this.f, this.f = a)
    };

    function Fa() {
        this.h = this.f = null
    }
    var Ha = new Ea(function() {
        return new Ga
    }, function(a) {
        a.reset()
    }, 100);
    Fa.prototype.remove = function() {
        var a = null;
        this.f && (a = this.f, this.f = this.f.next, this.f || (this.h = null), a.next = null);
        return a
    };
    ...
    g.N = function(a) {
        ...
        if (b) {
            var c = this.h[b];
            if (0 != this.v) this.m.push(a), this.f[a + 1] = aa;
            else {
                if (c) {
                    var d = ga(c, a);
        ...
        if (c) {
            ...
            if (this.D)
                for (e = 0; e < c.length; e++) {
                    var h = c[e];
                    Oa(this.f[h + 1], this.f[h + 2], d)
                } else {
                    this.v++;
                    try {
                        for (e = 0, f = c.length; e < f; e++) h = c[e], this.f[h + 1].apply(this.f[h + 2], d)
                    } finally {
                        if (this.v--, 0 < this.m.length && 0 == this.v)
                            for (; c = this.m.pop();) this.N(c)
                    }
                }
            return 0 != e
        }
    ...
    g.clear = function(a) {
        if (a) {
            var b = this.h[a];
            b && (x(b, this.N, this), delete this.h[a])
    ...
    function Za(a, b) {
        var c = l("yt.www.errors.log");
        c ? c(a, b) : (c = ("ERRORS" in M ? M.ERRORS : void 0) || [], c.push([a, b]), Wa("ERRORS", c))
    };
    ...
    function $a(a) {
        ...
        if (a = a || window.event) {
            this.event = a;
            for (var b in a) b in ab || (this[b] = a[b]);
    ...
    var z = l("yt.events.listeners_") || {};
    u("yt.events.listeners_", z);
    var bb = l("yt.events.counter_") || {
        count: 0
    };
    u("yt.events.counter_", bb);
    ...
    function jb(a) {
        return ib[a] || (ib[a] = String(a).replace(/\-([a-z])/g, function(a, c) {
    ...
    function ob(a) {
        var b = y(document.getElementsByTagName("yt:" + a));
        a = "yt-" + a;
        var c = document;
    ...
    function O(a, b) {
        return "yt:" == a.tagName.toLowerCase().substr(0, 3) ? a.getAttribute(b) : a ? a.dataset ? a.dataset[jb(b)] : a.getAttribute("data-" + b) : null
    }

    function pb(a, b) {
        L.R.apply(L, arguments)
    };
    ...
    function P(a, b, c) {
        ...
        if (a = q(a) ? b.getElementById(a) : a)
            if ("iframe" != a.tagName.toLowerCase() && (b = qb(this, a), this.m = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.f = a, this.f.id || (b = a = this.f, b = b[r] || (b[r] = ++ca), a.id = "widget" + b), N[this.f.id] = this, window.postMessage) {
                this.l = new K;
                rb(this);
                a = Q(this.h, "events");
                for (var d in a) a.hasOwnProperty(d) && this.addEventListener(d, a[d]);
                for (var e in lb) sb(this,
                    e)
            }
    }
    g = P.prototype;
    ...
    function qb(a, b) {
        for (var c = document.createElement("iframe"), d = b.attributes, e = 0, f = d.length; e < f; e++) {
            var h = d[e].value;
            null != h && "" != h && "null" != h && c.setAttribute(d[e].name, h)
        }
        ...
        window.location.host && (m.origin = window.location.protocol + "//" + window.location.host);
        ...
        c.src = Q(a.h, "host") + a.I() + "?" + Ra(m);
        return c
    }
    g.P = function() {
        this.f && this.f.contentWindow ? this.L({
            event: "listening"
    ...
    function rb(a) {
        ub(a.h, a, a.v);
        a.j = Xa(t(a.P, a));
        db(a.f, "load", t(function() {
            window.clearInterval(this.j);
            this.j = Xa(t(this.P, this))
        }, a))
    }

    function tb(a, b) {
        a.D[b] || (a.D[b] = !0, S(a, "addEventListener", [b]))
    }
    g.L = function(a) {
        a.id = this.v;
        a = Aa(a);
        ...
        for (c = 0; c < b.length; c++) try {
            ...
            if (m.name && "SyntaxError" == m.name) Za(m, "WARNING");
            else throw m;
        }
    };
    var T = "StopIteration" in k ? k.StopIteration : {
    ...
    function ub(a, b, c) {
        R || (R = {}, db(window, "message", t(a.l, a)));
        R[c] = b
    }
    W.prototype.l = function(a) {
        var b;
        (b = a.origin == Q(this, "host")) || ((b = a.origin) && b == Fb ? b = !0 : (new RegExp("^(https?:)?//([a-z0-9-]{1,63}\\.)*(" + Eb.join("|").replace(/\./g, ".") + ")(:[0-9]+)?([/?#]|$)", "i")).test(b) ? (Fb = b, b = !0) : b = !1);
        if (b) {
            var c;
            try {
                c = za(a.data)
            ...
            if (a = R[c.id]) a.K = !0, a.K && (x(a.H, a.L, a), a.H.length = 0), a.S(c)
        }
    };
    ...
    function Jb(a, b) {
        x(b, function(a) {
            this[a] || (Cb(a) ? this[a] = function() {
                this.B = {};
                this.o = {};
                S(this, a, arguments);
                return this
            } : Db(a) ? this[a] = function() {
                var b = 0;
    ...
    Y.prototype.A = function(a, b) {
        Y.M.A.call(this, a, b ? b.info : void 0)
    };
    ...
    u("YT.Thumbnail", Y);
    u("YT.UploadWidget", Z);
    P.prototype.destroy = P.prototype.Y;
    P.prototype.setSize = P.prototype.$;
    P.prototype.getIframe = P.prototype.Z;
    P.prototype.addEventListener = P.prototype.addEventListener;
    X.prototype.getVideoEmbedCode = X.prototype.ca;
    X.prototype.getOptions = X.prototype.ba;
    X.prototype.getOption = X.prototype.aa;
    Z.prototype.setVideoDescription = Z.prototype.T;
    Z.prototype.setVideoKeywords = Z.prototype.V;
    Z.prototype.setVideoPrivacy = Z.prototype.W;
    Z.prototype.setVideoTitle = Z.prototype.X;
    Z.prototype.setVideoDraftPrivacy = Z.prototype.U;
    kb.push(function() {
        var a = ob("player");
        x(a, Hb)
    });
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || nb();
    var Nb = l("onYTReady");
    Nb && Nb();
    var Ob = l("onYouTubeIframeAPIReady");
    Ob && Ob();
    var Pb = l("onYouTubePlayerAPIReady");
    Pb && Pb();
})();
